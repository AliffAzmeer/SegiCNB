  ...
  const body = isBM
    ? `
      ...
      <div class="lt-sn-bm-rows">
        ...
        <div class="lt-sn-bm-row"><span class="lt-sn-bm-label"><b>Baki Ganti Notis</b></span><span class="lt-sn-bm-colon">:</span><span class="lt-sn-bm-value"><b>${esc(shortNoticeBalance || "0")}</b> hari / <b>RM${esc(totalPaidAmountMoney)}</b></span></div>
        <div class="lt-sn-bm-row"><span class="lt-sn-bm-label"><b>Cuti Tahunan Melebihi Kelayakan</b></span><span class="lt-sn-bm-colon">:</span><span class="lt-sn-bm-value"><b>${esc(overtakenAl || "0")}</b> hari/<b>RM${esc(overtakenAlAmtMoney)}</b></span></div>
  ...
  const paymentDetails = isBM
    ? `
      ...
      <div class="lt-sn-bm-pay-rows">
        ...
        <div class="lt-sn-bm-row"><span class="lt-sn-bm-label"><b>Nama Syarikat</b></span><span class="lt-sn-bm-colon">:</span><span class="lt-sn-bm-value"><b>${esc(accountName)}</b></span></div>
